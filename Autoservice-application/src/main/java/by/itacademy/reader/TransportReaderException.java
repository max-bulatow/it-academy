...
public class TransportReaderException extends Exception {
    ...
    В конструктор передаются неизменяемая (final - т.к. ее ссылка не должна меняться) переменная message*/
    ...
    /*Конструктор класса TransportReaderException, в который передаются неизменяемые (final - т.к. их ссылки не должна меняться)
    переменные message и cause*/
