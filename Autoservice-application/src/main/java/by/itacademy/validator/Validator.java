...
public interface Validator {
    ...
    List<Transport>*/
    Map<String, List<Transport>> mapTransportList(final String validTransport, final String invalidTransport, final List<Transport> transportList) throws FieldValidatorException;
}
