...
public class StudentRestController {
    ...
    @Parameters(@Parameter(name = "id", required = true, description = "Student Id", example = "1"))
    @GetMapping(path = "/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    public StudentDto getByID(@Min(value = 1, message = "Id must be more than 0") final Integer id) {
    ...
    public Integer save(@RequestBody @Valid CreateStudentDto dto) {
    ...
    public Integer update(@RequestBody @Valid StudentDto dto) {
